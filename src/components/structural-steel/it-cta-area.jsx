...
const it_cta_content = {
    ...
    des: <>Choose our company for all your steel structural detailing needs, 
    and experience reliable, accurate, and timely services that exceed your expectations.</>
}
